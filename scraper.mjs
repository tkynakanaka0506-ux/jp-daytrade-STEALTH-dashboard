...
<style>
  :root{
    ...
    --txt:#ffffff; --dim:#d9e6fb; --cyan:#31e0ff; --mint:#22ffc4;
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .logo span{font:700 18.5px/1 var(--mono);color:var(--cyan)}
  h1{font-size:25px;font-weight:600;letter-spacing:.16em}
  h1 b{color:var(--cyan);font-weight:600}
  .sub{font:400 13px/1 var(--mono);color:var(--dim);letter-spacing:.24em;margin-top:6px}
  .live{display:flex;align-items:center;gap:7px;font:500 13px/1 var(--mono);
  ...
  .ro-k{display:block;font:500 12px/1 var(--mono);color:var(--dim);letter-spacing:.2em;margin-bottom:7px}
  .ro-v{font:600 25px/1 var(--mono);color:var(--txt);letter-spacing:.01em}
  .ro-v i{font-style:normal;font-size:13.5px;color:var(--dim);margin-left:3px}
  ...
  .guide summary{list-style:none;cursor:pointer;padding:14px 0;
                 font:600 14px/1 var(--mono);color:var(--cyan);letter-spacing:.06em;
  ...
  .guide-h{font:700 12px/1 var(--mono);color:var(--dim);letter-spacing:.1em;margin-bottom:10px}
  .guide-list{list-style:none;display:flex;flex-direction:column;gap:9px}
  .guide-list li{font:400 13.5px/1.6 -apple-system,BlinkMacSystemFont,"Hiragino Sans","Noto Sans JP",sans-serif;
                 color:var(--dim)}
  ...
  .sec-head h2{font-size:18.5px;font-weight:600;letter-spacing:.13em;display:flex;align-items:center;gap:9px}
  .ico{font-size:18.5px}
  ...
  .sec-badge{margin-left:auto;font:600 12px/1 var(--mono);letter-spacing:.08em;color:var(--dim);
             border:1px solid var(--line);border-radius:5px;padding:4px 9px;white-space:nowrap;flex-shrink:0}
  .sec-head p{font:400 13px/1.6 var(--mono);color:var(--dim);letter-spacing:.06em;flex-basis:100%}
  ...
  .empty{padding:26px 22px;border:1px dashed var(--line);border-radius:12px;
         font:400 14px/1.8 var(--mono);color:var(--dim);background:rgba(12,18,30,.4)}

  /* ── AMBUSH WATCHのサブグループ見出し（仕込み候補 / 参考） ── */
  .subhead{font:700 12.5px/1 var(--mono);letter-spacing:.1em;margin:22px 0 13px;
  ...
  .code{font:600 12.5px/1 var(--mono);color:var(--cyan);letter-spacing:.22em;
        padding:4px 8px;border:1px solid rgba(49,224,255,.3);border-radius:5px;
        background:rgba(49,224,255,.07);display:inline-block}
  .rank{font:700 12.5px/1 var(--mono);letter-spacing:.1em;padding:4px 7px;border-radius:5px;
  ...
  /* ── セクション内の順位バッジ ── */
  .rankpos{font:700 12px/1 var(--mono);letter-spacing:.06em;padding:4px 8px;border-radius:5px;
  ...
  .name{font-size:21px;font-weight:600;margin-top:9px;letter-spacing:.03em}
  .gauge{flex:none;margin:-2px -3px 0 0}
  .gauge-v{font:600 21px/1 var(--mono)}
  .gauge-u{font:500 9px/1 var(--mono);fill:var(--dim);letter-spacing:.16em}
  .score-col{display:flex;flex-direction:column;align-items:center;gap:2px}
  .conviction-note{font:700 11px/1 var(--mono);color:var(--mint);letter-spacing:.04em;cursor:default}
  ...
  .smart-score-v{display:block;font:600 21px/1 var(--mono);color:var(--cyan)}
  .smart-score-u{font:500 9px/1 var(--mono);color:var(--dim);letter-spacing:.16em}

  /* ── ステータスランプ（買い推奨/様子見/見送り） ── */
  .score-trio{display:flex;flex-wrap:wrap;align-items:center;gap:6px;margin-top:8px}
  .score-trio i{font-style:normal;color:var(--dim);font-size:12px}
  ...
  .reason-title{font:700 12px/1.4 var(--mono);color:var(--dim);letter-spacing:.03em}
  .reason-group ul{margin:2px 0 0;padding-left:18px;font:500 12.5px/1.5 var(--mono);color:var(--txt)}
  ...
  .exit-plan-h{font:700 12px/1.4 var(--mono);color:var(--blue);letter-spacing:.03em}
  .exit-plan-deadline{margin-top:2px;font:600 12.5px/1.4 var(--mono);color:var(--txt)}
  .exit-plan ul{margin:4px 0 0;padding-left:18px;font:500 12px/1.5 var(--mono);color:var(--dim)}
  ...
  .verdict-label{font:700 15px/1 var(--mono);letter-spacing:.06em}
  .verdict-reason{flex-basis:100%;font:500 12.5px/1.4 var(--mono);color:var(--dim);letter-spacing:.02em}
  ...
  .price{font:600 33.5px/1 var(--mono);letter-spacing:-.01em}
  .chg{font:600 15.5px/1 var(--mono);padding-bottom:4px}
  .chg .arrow{font-size:10px;margin-right:2px;vertical-align:1px}
  ...
  .k{font:500 12px/1.35 var(--mono);color:var(--dim);letter-spacing:.11em}
  .k i{font-style:normal;opacity:.6;font-size:11px;display:block;margin-top:2px}
  .v{font:600 17.5px/1 var(--mono)}
  ...
  .sig-e{font-size:16px;line-height:1}
  .sig-t{font:500 12px/1.2 var(--mono);color:var(--dim);letter-spacing:.08em;flex:1}
  .sig-n{margin-top:5px;font:500 12px/1.4 var(--mono);color:var(--dim);letter-spacing:.02em}
  ...
  .rulebox-head{font:700 11px/1 var(--mono);color:var(--dim);letter-spacing:.1em;margin-bottom:7px}
  .rulebox-score{color:var(--txt);font-weight:700}
  .rulebox-rows{display:flex;flex-wrap:wrap;gap:6px}
  .rule{font:600 11px/1 var(--mono);letter-spacing:.04em;padding:4px 8px;border-radius:14px;
  ...
  .peerbox{margin-top:13px;padding:9px 12px;border:1px solid var(--line);border-radius:9px;
           background:rgba(9,14,24,.72)}
  .peerbox-head{font:700 11px/1 var(--mono);color:var(--dim);letter-spacing:.1em;margin-bottom:7px}
  .peerbox-sub{color:var(--txt);font-weight:700;margin-left:4px}
  .peer-table{width:100%;border-collapse:collapse;font:500 12px/1.6 var(--mono)}
  .peer-table th{color:var(--dim);font-weight:500;text-align:right;letter-spacing:.06em;font-size:10.5px}
  ...
  .peerbox-note{margin-top:8px;padding-top:8px;border-top:1px dashed var(--line);
                font:500 11.5px/1.5 var(--mono);color:var(--amber);letter-spacing:.01em}
  ...
  .timing-note{margin-top:8px;padding:7px 12px;border:1px solid rgba(49,224,255,.25);
               ...
               font:500 12px/1.5 var(--mono);color:var(--dim);letter-spacing:.01em}
  ...
  .precursor-item-head{font:700 12.5px/1 var(--mono);color:#b39cff;letter-spacing:.04em;margin-bottom:6px}
  .precursor-item-note{font:500 12px/1.6 var(--mono);color:var(--dim);letter-spacing:.01em}
  ...
  .precursor-supply-badge{flex-shrink:0;padding:4px 9px;border-radius:7px;border:1px solid;
                           font:700 11.5px/1 var(--mono);letter-spacing:.02em;white-space:nowrap}
  ...
  .why-now-h{display:block;font:700 11px/1 var(--mono);color:var(--cyan);letter-spacing:.1em;margin-bottom:6px}
  .why-now-item p{font:500 12.5px/1.6 var(--mono);color:var(--txt);letter-spacing:.01em}
  .why-now-item ul{list-style:none;display:flex;flex-direction:column;gap:4px}
  .why-now-item li{font:500 12px/1.5 var(--mono);color:var(--dim);letter-spacing:.01em}
  ...
  .infl-type{display:inline-flex;align-items:center;gap:6px;padding:5px 12px;border-radius:20px;
             font:700 12.5px/1 var(--mono);letter-spacing:.06em;border:1px solid;margin:10px 0 2px}
  ...
  .infl-line b{display:block;font:700 11px/1 var(--mono);color:var(--dim);letter-spacing:.1em;
               margin-bottom:6px;text-transform:uppercase}
  .infl-line div{font:500 12.5px/1.6 var(--mono);color:var(--txt);letter-spacing:.01em}
  ...
  .infl-killer-cell .kv{font:700 15px/1.25 var(--mono);color:var(--txt);white-space:nowrap}
  .infl-killer-cell.hit .kv{color:var(--mint)}
  .infl-killer-cell .kl{font:500 9.5px/1.3 var(--mono);color:var(--dim);letter-spacing:.03em;margin-top:3px}
  ...
  .divtrend-head{color:var(--dim);letter-spacing:.06em;font-size:10.5px}
  ...
  .altbox-head{font:700 11px/1 var(--mono);color:var(--mint);letter-spacing:.08em;margin-bottom:7px}
  .altbox-list{list-style:none;display:flex;flex-direction:column;gap:6px}
  .altbox-list li{font:500 12px/1.5 var(--mono);color:var(--dim);letter-spacing:.01em}
  ...
  .repricing-score{font:700 11.5px/1 var(--mono);color:var(--dim);letter-spacing:.04em}
  .repricing-fields{list-style:none;display:flex;flex-direction:column;gap:4px;margin-bottom:8px}
  .repricing-fields li{font:500 11.5px/1.5 var(--mono);color:var(--dim);letter-spacing:.01em}
  .repricing-why{font:500 12px/1.6 var(--mono);color:var(--txt);letter-spacing:.01em}
  .repricing-caveat{margin-top:6px;padding-top:6px;border-top:1px dashed var(--line);
                     font:500 11px/1.5 var(--mono);color:var(--amber);letter-spacing:.01em}

  .meta{display:flex;flex-wrap:wrap;gap:11px;margin-top:11px;
        font:500 12px/1 var(--mono);color:var(--dim);letter-spacing:.08em}
  ...
  .chip{font:500 12px/1 var(--mono);letter-spacing:.1em;padding:5px 9px;border-radius:20px;border:1px solid;cursor:default}
  ...
  .stamp{margin-top:26px;font:400 12.5px/1.7 var(--mono);color:var(--dim);letter-spacing:.13em}
  /* ── スマホ ────────────────────────────────────────────────
  ...
  @media(max-width:520px){
    ...
    .name{font-size:20px}
    .chip{font-size:11.5px;padding:5px 8px}
  }
